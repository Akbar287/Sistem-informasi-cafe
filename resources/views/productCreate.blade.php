                ...
                <form action="{{ url('/product') }}" method="POST">@csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="page-header">
                                <h2 class="mb-3 line-head">Tambah Produk</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    @error('unit')<div id="unit" class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                            </div>
                            <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-pencil"></i> Tambah Produk</button>
                        </div>
                    </div>
                </form>
            </div>
