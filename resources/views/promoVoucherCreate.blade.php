            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header">
                        <h2 class="mb-3 line-head">Tambah Voucher</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <form action="{{ url('/promo/voucher') }}" method="POST">@csrf
                        <div class="form-group row">
                            <label for="name" class="control-label col-md-3">Nama Voucher</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group mb-3">
                                    <input type="text" value="{{ old('code') }}" readonly class="form-control @error('code') is-invalid @enderror" name="code" id="code">
                        ...
                        <div class="form-group row">
                            <label for="isActive" class="control-label col-md-3">Aktifkan Voucher</label>
                            <div class="col-md-8">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-8 text-center">
                                <button type="submit" class="btn btn-primary" title="Simpan Voucher"><i class="fa fa-pencil"></i> Simpan Voucher</button>
                            </div>
                        </div>
                    </form>
                </div>
