...
<div class="app-title">
    <div>
        <h1><a href="{{ url('/product/' . $product->product_id . '/varian/'. $variant->product_variation_id) }}" class="btn"><i class="fa fa-arrow-left"></i></a> {{ $title }}</h1>
    </div>
    <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('/product/' . $product->product_id . '/varian/'. $variant->product_variation_id) }}">Lihat Varian</a></li>
        <li class="breadcrumb-item active">Ubah Variant</li>
    </ul>
</div>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="tile mb-4">
                <form action="{{ url('/product/' . $product->product_id . '/varian/'.$variant->product_variation_id) }}" method="POST" enctype="multipart/form-data">@csrf @method('put')
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="page-header">
                                <h2 class="mb-3 line-head">Ubah Varian Produk {{ $product->title }}</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center mt-3">
                        <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-12">
                                    <div class="input-group mb-3" id="image-preview-edit-div">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Unggah</span>
                                        </div>
                                        <div class="custom-file">
                                            <input type="file" name="image" class="custom-file-input" id="image-preview-edit">
                                ...
                                <div class="col-8 text-center m-2">
                                    <button class="btn btn-info btn-block btn-times-image-variant" style="display: none;"><i class="fa fa-undo"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select name="variant" id="variant" class="custom-select">
                                        ...
                                        <option value="{{ $vo->variant_name }}" {{ ($vo->variant_name == $variant->variation_name) ? 'selected' : '' }}>{{ $vo->variant_name . ' ('. $vo->variant_option .') ' }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $variant->title }}" class="form-control @error('title') is-invalid @enderror " name="title" id="title">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $variant->weight }}" class="form-control @error('weight') is-invalid @enderror " name="weight" id="weight">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        <input type="text" id="length" value="{{ $variant->length }}" name="length" placeholder="Panjang" class="form-control">
                                        <input type="text" value="{{ $variant->width }}" name="width" placeholder="Lebar" class="form-control">
                                        <input type="text" value="{{ $variant->height }}" name="height" placeholder="Tinggi" class="form-control">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" value="{{ explode('.', $variant->price)['0'] }}" class="form-control @error('price') is-invalid @enderror " name="price" id="price">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $variant->sku }}" class="form-control @error('sku') is-invalid @enderror " name="sku" id="sku">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $variant->barcode }}" class="form-control @error('barcode') is-invalid @enderror " name="barcode" id="barcode">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" value="{{ $variant->isAlertStock }}" class="form-control @error('isAlertStock') is-invalid @enderror " name="isAlertStock" id="isAlertStock">
                            ...
                            <div class="form-group row">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ ($variant->isManageStock == 1) ? 'checked' : '' }} class="custom-control-input" name="isManageStock" id="isManageStock">
                            ...
                            <div class="form-group row">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" {{ ($variant->isSale == 1) ? 'checked' : '' }} class="custom-control-input" name="isSale" id="isSale">
                            ...
                            <div class="btn-group">
                                ...
                                <button class="btn btn-primary" type="submit"><i class="fa fa-pencil"></i> Ubah Varian Produk</button>
                            </div>
                        </div>
                    </div>
                </form>
