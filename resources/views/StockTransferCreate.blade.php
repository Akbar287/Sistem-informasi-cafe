    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="tile mb-4">
                ...
                <form action="{{ url('/stock/transfer') }}" method="post">@csrf
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-10">
                            <div class="form-group row">
                                <label for="byOutlet" class="control-label col-md-3"> Dari Outlet</label>
                                <div class="col-md-8">
                                    <select name="byOutlet" class="custom-select" id="byOutlet">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select name="toOutlet" class="custom-select" id="toOutlet">
                                        <option value="0">Pilih Outlet</option>
                                        @foreach($outlets as $outlet)
                                        <option value="{{ $outlet->outlet_id }}">{{ $outlet->name }}</option>
                                        @endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" value="{{ old('time') }}" type="datetime-local" name="time" id="time">
                    ...
                    <div class="row notice m-3">
                        <div class="col-md-12 text-center">
                            <p>Pilih Outlet Terlebih dahulu!</p>
                        </div>
                    </div>
                    <div class="row m-3">
                        <div class="col-12 col-md-12 col-lg-6 btn-option-table text-center" style="display: none;">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 text-center">
                            <div class="btn-group">
                                ...
                                <button type="submit" class="btn btn-primary" title="Tambah Stok"><i class="fa fa-pencil"></i> Transfer Stok</button>
                            </div>
                        </div>
                    </div>
                </form>
